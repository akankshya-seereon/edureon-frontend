...
const INITIAL_COURSES = [
  {
    ...
    semSystem: 'Semester',
    semesters: 8,
    building: 'Engineering & Technology Block',
    evaluation: 'CGPA',
    totalIntake: 300,
    currentIntake: 210,
    specializations: [
...
export default function AcademicProgram() { 
  ...
  const defaultCourseState = {
    name: '', code: '', level: 'UG', duration: '4 Years', semSystem: 'Semester', semesters: '8', building: '', evaluation: 'CGPA'
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
              ...
              <div className="flex flex-col gap-1.5 text-left">
                ...
                {buildingsLoading ? (
                  ...
                  <select
                    value={courseFormData.building}
                    onChange={e => setCourseFormData({...courseFormData, building: e.target.value})}
                  ...
                  <input
                    ...
                    value={courseFormData.building}
                    onChange={e => setCourseFormData({...courseFormData, building: e.target.value})}
                    className="px-3 py-2.5 border border-gray-200 rounded-lg text-sm font-semibold text-gray-800 bg-white focus:border-blue-500 outline-none"
                  />
                )}
              </div>
...
const BatchesSection = ({ course, fetchPrograms, api, courseSpecializations }) => {
  ...
  const handleAddNewBatch = () => {
    setEditBatchData({ 
      id: 'NEW', name: '', startMonth: 'Jul', startYear: currentYear.toString(), 
      endMonth: 'Jun', endYear: (currentYear + 4).toString(), sections: ['A'], specs: [] 
    });
