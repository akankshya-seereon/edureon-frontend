      ...
      <div className="space-y-2">
        <div>
          ...
          <Input
            ...
            placeholder={numberPlaceholder || "Enter reference number"}
            error={error}
          />
...
export default function InstituteForm() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      alert(err?.message || "Failed to create institute");
    } finally {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 text-left">
      <div className="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-6xl mx-auto">
        ...
        {/* Error Summary Banner — only shown after clicking Next */}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  {
                    label: "Directors",
                    desc: `${form.directors.length} director(s) added`,
                  },
                  {
                    label: "Legal Documents",
                    desc: "Legal details and certifications submitted",
                  },
                  {
                    label: "Branches",
                    desc: hasBranch ? `${form.branches.length} branch location(s) configured` : "No branch associated",
                  },
                ].map((item, i) => (
